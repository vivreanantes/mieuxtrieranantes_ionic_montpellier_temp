var _hashGarbagesDatas = [
		{
			...
			'base' : 'dec_acides',
			'produit' : 'dec_acides,dec_bouteilleProduitMenagerNonVide,dec_bouteilleProduitMenagerVide,dec_detachant,dec_flaconProduitsDentretien,dec_produitPhytosanitaire,dec_produitsDEntretien,dec_produitsTraitementDuBois',
			'chimique' : 'dec_acides',
			...
			'agenda' : 'dec_agenda',
			'a' : 'bba',
			'ampoule' : 'dec_ampouleBasseConso,dec_ampouleBasseConso,dec_ampouleClassique,dec_ampouleClassique',
			...
			'electricit' : 'dec_appareilElectronique',
			...
			'petit' : 'dec_appareilsElectromenager',
			'baril' : 'dec_barilLessive',
			'lessive' : 'dec_barilLessive',
			'paquets' : 'dec_barilLessive',
			'lessives' : 'dec_barilLessive',
			'barils' : 'dec_barilLessive',
			...
			'batteries' : 'dec_batteriesVoiture',
			...
			'metal' : 'dec_bidonMetal,dec_capsuleCafe',
			...
			'œufs' : 'dec_boiteAOeufsEnPlastique,dec_boiteOeufsEnCarton',
			...
			'bouteilles' : 'dec_bouteillesSirop',
			...
			'(petits' : 'dec_cartonPetitsOuGrands',
			'grands)' : 'dec_cartonPetitsOuGrands',
			'cartouches' : 'dec_cartouchesEncres',
			...
			'chaussure' : 'dec_chaussureEnBonEtat,dec_chaussuresUsagees',
			...
			'chaussures' : 'dec_chaussuresUsagees',
			...
			'javel' : 'dec_eauJavel',
			'emballages' : 'dec_emballagesEnCartonPlat',
			...
			'epluchures' : 'dec_epeluchuresRestesRepas,dec_epeluchuresRestesRepas',
			'/' : 'dec_epeluchuresRestesRepas',
			'restes' : 'dec_epeluchuresRestesRepas,dec_epeluchuresRestesRepas',
			'repas' : 'dec_epeluchuresRestesRepas,dec_epeluchuresRestesRepas',
			...
			'pomme' : 'dec_epeluchuresRestesRepas,dec_epeluchuresRestesRepas',
			...
			'pois' : 'dec_epeluchuresRestesRepas,dec_epeluchuresRestesRepas',
			...
			'equipements' : 'dec_equipementsAudioEtVideo',
			...
			'film' : 'dec_filmPlastique',
			'films' : 'dec_filmsPhotographiques',
			...
			'produits' : 'dec_flaconProduitsDentretien,dec_flaconProduitsDentretien,dec_produitsBeaute',
			...
			'fournitures' : 'dec_fournituresHorsPapier,dec_fournituresHorsPapier',
			'(hors' : 'dec_fournituresHorsPapier',
			...
			'neon' : 'dec_neons',
			'nettoyant' : 'dec_nettoyantsALAmmoniac,dec_produitsDEntretien',
			'lammoniac' : 'dec_nettoyantsALAmmoniac',
			'nettoyants' : 'dec_nettoyantsCuivreEtArgenterie',
			...
			'ordinateurs' : 'dec_ordinateursPortables',
			'portables' : 'dec_ordinateursPortables',
			'outils' : 'dec_outilsBricolageOuJardinage',
			...
			'peripheriques' : 'dec_peripheriquesInformatiques',
			...
			'recurant' : 'dec_recurantsPourFour',
			'recurants' : 'dec_recurantsPourToilette',
		...
		},
		{
			...
			'bulb' : 'dec_ampouleBasseConso,dec_ampouleBasseConso,dec_ampouleClassique,dec_ampouleClassique',
			...
			'batteries' : 'dec_batteriesVoiture,dec_piles,dec_piles',
			...
			'peelings' : 'dec_epeluchuresRestesRepas,dec_epeluchuresRestesRepas',
			...
			'apple' : 'dec_epeluchuresRestesRepas,dec_epeluchuresRestesRepas',
			...
			'bean' : 'dec_epeluchuresRestesRepas',
			...
			'peas' : 'dec_epeluchuresRestesRepas,dec_epeluchuresRestesRepas',
			...
			'battery' : 'dec_jouetsAlimentesParElectricite',
